using BookMyShowProject.infrastructure.EntityConfiguration;
...
namespace BookMyShowProject.infrastructure.Extension
{
    internal static class ModelBuilderExtension
    {
        internal static void RegisterEntityConfigurations(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new PayementEntityTypeConfiguarction());
