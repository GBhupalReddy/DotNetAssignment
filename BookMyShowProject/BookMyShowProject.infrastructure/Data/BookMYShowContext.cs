...
namespace BookMyShowProject.infrastructure
{
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CinemaHall>(entity =>
            {
                ...
                entity.HasOne(d => d.Cinema)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CinemaHal__Cinem__5535A963");
            });
            ...
            modelBuilder.Entity<City>(entity =>
            {
                ...
                entity.HasIndex(e => e.Name, "UQ__City__737584F618C1D84F")
                    .IsUnique();
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasIndex(e => e.Phone, "UQ__Users__5C7E359E35EF1B72")
                    .IsUnique();

                entity.HasIndex(e => e.Email, "UQ__Users__A9D10534801064D6")
                    .IsUnique();
