    ...
    public class EmployeeManagementService : IEmployeeManagementInterface
    {
        ...
        public IEnumerable<CombineEntities> GetDeatils()
        {
            var result = (from department in departments
                         ...
                         select new 
                         { DepartmentName = department.DepartmentName, EmployeeName = employee.EmployeeName, 
                             ProjectName = project.ProjectName, AssignmentName = assignment.AssignmentName }).Distinct();
